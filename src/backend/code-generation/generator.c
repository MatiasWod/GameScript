...
function * functions; // define la funcion con todo lo que hace
int functions_counts;

block * blocks; // block, directamente se drawean (se les puede asignar position, color y movement)
int block_count = 0;

text * texts; // se escribe en pantalla directamente(color y posicion)
int text_count = 0;

button * buttons; // se pone directo en pantalla, se define el comportamiento con OnClick
int button_count = 0;

condition * conditionals;
int conditionals_count = 0;
